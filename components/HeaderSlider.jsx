          ...
          >
            {sliderData.length > 0 &&
              sliderData.map((slide, index) => (
                <div
                  key={slide?.id}
                  className="flex md:flex-col-reverse lg:flex-row items-center justify-between bg-[#031057] py-8 md:px-14 px-5 rounded-b-[50px] md:rounded-b-[80px] min-w-full h-full relative"
                >
                  {/* Text Section */}
                  <div className="relative md:pl-8 mt-10 md:mt-0">
                    <h1 className="max-w-lg text-[41px] md:text-[40px] leading-[50px] md:leading-[48px] text-2xl font-semibold text-white  md:mt-24">
                      {slide?.offer}
                    </h1>
                  ...
                  {/* Image Section */}
                  <div className="hidden md:flex items-center flex-1 justify-center h-full mt-28">
                    <Image
                      className="md:max-w-[300px] lg:max-w-[500px] h-auto"
                      src={slide.imgSrc}
                      alt={`Slide ${index + 1}`}
                    />
                  </div>
